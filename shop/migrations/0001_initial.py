    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('M_price', models.DecimalField(decimal_places=2, max_digits=5)),
                ...
                ('W_price', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('b_price', models.DecimalField(decimal_places=2, max_digits=5)),
                ('b_image', models.ImageField(upload_to='images')),
                ('M_name', models.CharField(max_length=100)),
                ('M_price', models.DecimalField(decimal_places=2, max_digits=5)),
                ('M_image', models.ImageField(upload_to='images')),
                ('R_name', models.CharField(max_length=100)),
                ('R_price', models.DecimalField(decimal_places=2, max_digits=5)),
                ('R_image', models.ImageField(upload_to='images')),
                ('O_name', models.CharField(max_length=100)),
                ('O_price', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Mens'), ('W', 'Womens'), ('E', 'Electronics')], default='Pending', max_length=1)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.customer_personal')),
