...
class arrivals(models.Model):
    ...
    l_image=models.ImageField(upload_to='images')
    l_Discounts=models.CharField(max_length=100)
    d_image=models.ImageField(upload_to='images')
    d_Discounts=models.CharField(max_length=100)
    s_image=models.ImageField(upload_to='images')
    Season=models.CharField(max_length=100)
    Category=models.CharField(max_length=100)
    date=models.DateField(auto_now=True)

class arrivals1(models.Model):
    M_name=models.CharField(max_length=100)
    M_price=models.DecimalField(max_digits=5, decimal_places=2)
    M_image=models.ImageField(upload_to='images')
    M_Discription=models.CharField(max_length=100)
    W_Discription=models.CharField(max_length=100)
    W_name=models.CharField(max_length=100)
    W_price=models.DecimalField(max_digits=5, decimal_places=2)
    W_image=models.ImageField(upload_to='images')
...
class electronic(models.Model):
    ...
    R_price=models.DecimalField(max_digits=5, decimal_places=2)
    ...
    O_image=models.ImageField(upload_to='images')
    date=models.DateField(auto_now=True)
...
class simple(models.Model):
    ...
    login_account=models.CharField(max_length=100)
    select_item=models.CharField(max_length=100)
    make_payment=models.CharField(max_length=500)
    date=models.DateField(auto_now=True)  
