...
from .models import product, sign_up,arrivals,arrivals1,electronic,men,women,contact,info,simple,carts,Customer,reqq,Placed
...
class ProductView(View):
    def get(self, request):
        ...
        b= arrivals1.objects.all()
        h=info.objects.all()
        t=simple.objects.all()
        form = CustomerRegistraionForm()
        return render(request, 'shop/index.html', {'Mens':Mens,'Womens':Womens,'Electronics':Electronics,'A':a,'B':b,'H':h,'T':t,'form':form})
...
class ProductView1(View):
    def get(self, request):
        ...
        h=info.objects.all()
        t=simple.objects.all()
        return render(request, 'shop/mens.html', {'Mens':Mens,'D':d,'H':h,'T':t}) 
class ProductView2(View):
    def get(self, request):
        ...
        h=info.objects.all()
        t=simple.objects.all()
        return render(request, 'shop/womens.html', {'Womens':Womens,'E':e,'H':h,'T':t})       
class ProductView3(View):
    def get(self, request):
        Electronics=product.objects.filter(category='E')
        c= electronic.objects.all()
        h=info.objects.all()
        t=simple.objects.all()
        return render(request, 'shop/electronics.html', {'Electronics':Electronics,'C':c,'H':h,'T':t})
...
class productdetailview(View):
    def get(self, request, pk):
     ...
     h=info.objects.all()
     t=simple.objects.all()
     return render(request,'shop/single.html', {'P':p,'T':t,'H':h})
...
#class contactview(View):
    #def get(self, request):
       ...
       #return render(request, 'shop/contact.html', {'J':j})  
...
def emptycart(request):
     h=info.objects.all()
     t=simple.objects.all()
     return render(request,'shop/emptycart.html',{'H':h,'T':t})
...
class ProfileView(View):
    def get(self, request):
        ...
        return render(request,'shop/profile.html',{'H':h,'T':t,'form':form})
    def post(self, request):
...
def placeorder(request):
    ...
    if cart_product:
      for p in cart_product:
        ...
        amount += tempamount
      totalamount = amount + shipping_amount
    return render(request,'shop/placeorder.html',{'add':add,'totalamount':totalamount,'cart_items':cart_items,'T':t,'H':h}) 
@ login_required  
